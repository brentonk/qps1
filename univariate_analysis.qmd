...
```{r analyze-competitiveness-by-year}
df_county_pres |>
  group_by(year) |>
  summarize(
...
```{r analyze-competitiveness-categories}
df_county_pres |>
